...
const Login = ({pageVariants, triggerPopup, popupActive, setPopupActive, popupConfig, setPopupConfig}) => {
    ...
    try {
      ...
      triggerPopup(
        ...
        <p className="py-4 text-sm lg:text-base leading-6 md:leading-7 font-semibold tracking-normal text-black text-left">
          <span className="font-extrabold text-red-calm">Login</span> berhasil
        </p>
      );

      if (loggedInUser && loggedInUser.role === 'officer') {
          navigate('/officer');
        } else {
          navigate('/visitor');
      }
  ...
  return (
    ...
    >
      ...
      />
      <section className="bg-white py-16 md:py-32 px-4 sm:px-8 relative overflow-hidden font-inter min-h-screen flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 flex flex-col items-center">
              <div className="w-full max-w-md space-y-6">
                ...
                <h3 className="text-2xl font-inter font-bold text-black text-center mb-4 tracking-wide">Login</h3>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* <div className="pt-2 pl-2 space-y-1">
                    <p className="text-[11px] font-bold text-gray-800 flex items-center gap-1.5">
                      <span className="w-1 h-1 bg-gray-800 rounded-full inline-block"></span>
                  ...
                  <div className="text-center pt-4">
                    <button type="submit" className="w-full sm:w-auto bg-red-calm text-white font-bold px-16 py-3 rounded-full text-sm shadow-[0_10px_25px_rgba(239,51,38,0.25)] hover:bg-red-700 transition-all duration-300 hover:scale-[1.02]">
                      Login
                    </button>
                  </div>

                  {/* <div className="text-center pt-2">
                    <button onClick={() => navigate('/contact')} className="text-red-calm text-[11px] font-bold hover:underline tracking-wide">
